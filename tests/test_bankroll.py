...
class TestBankrollManager:
    ...
    def test_get_bankroll_stats(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            required_keys = [
                "current_bankroll", "start_capital", "total_trades",
                "winning_trades", "total_pnl", "max_drawdown",
                "peak_bankroll", "created_at", "last_updated", "trade_history"
            ]
...
class TestTradeRecording:
    ...
    def test_update_bankroll_manual(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = manager.update_bankroll(120.0, "Manual adjustment after realized gains")
