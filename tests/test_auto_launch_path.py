...
class TestAutoLaunchPath:
    ...
    def test_submitted_trade_with_auto_start_enabled(self, mock_position_class, mock_ensure_monitor):
    ...
    @patch('utils.monitor_launcher.ensure_monitor_running')
    @patch('utils.portfolio.Position')
    def test_submitted_trade_with_auto_start_disabled(self, mock_position_class, mock_ensure_monitor):
    ...
    @patch('utils.monitor_launcher.ensure_monitor_running')
    @patch('utils.portfolio.Position')
    def test_cancelled_trade_no_auto_start(self, mock_position_class, mock_ensure_monitor):
    ...
    @patch('utils.monitor_launcher.ensure_monitor_running')
    @patch('utils.portfolio.Position')
    def test_auto_start_monitor_failure_handling(self, mock_position_class, mock_ensure_monitor):
    ...
    @patch('utils.monitor_launcher.ensure_monitor_running')
    @patch('utils.portfolio.Position')
    def test_auto_start_monitor_exception_handling(self, mock_position_class, mock_ensure_monitor):
    ...
    @patch('utils.monitor_launcher.ensure_monitor_running')
    @patch('utils.portfolio.Position')
    def test_default_auto_start_behavior(self, mock_position_class, mock_ensure_monitor):
