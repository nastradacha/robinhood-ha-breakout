...
class TestSlackConfirmation:
    ...
    def enhanced_slack(self):
        ...
        with patch("utils.enhanced_slack.SlackNotifier"), patch(
            "utils.enhanced_slack.SlackChartGenerator"
    ...
    def test_handle_submitted_message(
        self, enhanced_slack, mock_trade_confirmation_manager
    ):
        ...
        event = {"text": "submitted", "channel": "C1234567890", "user": "U1234567890"}
        ...
        mock_trade_confirmation_manager.record_trade_outcome.assert_called_once_with(
            "SUBMITTED", None
        )
        enhanced_slack._send_ephemeral_reply.assert_called_once_with(
            "C1234567890",
            "U1234567890",
            "✅ Trade recorded (SUBMITTED @ estimated price)",
        )

    def test_handle_filled_with_price_message(
        self, enhanced_slack, mock_trade_confirmation_manager
    ):
    ...
    def test_handle_filled_without_dollar_sign(
        self, enhanced_slack, mock_trade_confirmation_manager
    ):
        """Test handling of 'filled 0.85' confirmation message."""
        # Setup
        enhanced_slack.set_trade_confirmation_manager(mock_trade_confirmation_manager)
        event = {"text": "filled 0.85", "channel": "C1234567890", "user": "U1234567890"}
    ...
    def test_handle_cancelled_message(
        self, enhanced_slack, mock_trade_confirmation_manager
    ):
        """Test handling of 'cancelled' confirmation message."""
        # Setup
        enhanced_slack.set_trade_confirmation_manager(mock_trade_confirmation_manager)
        event = {"text": "cancelled", "channel": "C1234567890", "user": "U1234567890"}
    ...
    def test_handle_non_confirmation_message(
        self, enhanced_slack, mock_trade_confirmation_manager
    ):
        """Test handling of non-confirmation message."""
        # Setup
        enhanced_slack.set_trade_confirmation_manager(mock_trade_confirmation_manager)
        event = {"text": "hello world", "channel": "C1234567890", "user": "U1234567890"}
    ...
    def test_filled_price_parsing_edge_cases(
        self, enhanced_slack, mock_trade_confirmation_manager
    ):
        ...
        for text, expected_price in test_cases:
            event = {"text": text, "channel": "C1234567890", "user": "U1234567890"}
            ...
            # Assert
            assert result is True
            mock_trade_confirmation_manager.record_trade_outcome.assert_called_with(
    ...
    def test_invalid_filled_price_format(
        self, enhanced_slack, mock_trade_confirmation_manager
    ):
