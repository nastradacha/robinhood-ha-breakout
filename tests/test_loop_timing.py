...
from main import main_loop, parse_end_time
...
class TestLoopTiming:
    ...
    def setup_method(self):
        ...
        self.mock_env_vars = {"RH_USER": "test@example.com", "RH_PASS": "testpass"}
            ...
            with patch("main.datetime") as mock_dt:
                ...
                try:
                    main_loop(
                        ...
                        self.mock_args,
                        self.mock_env_vars,
                        self.mock_bankroll_manager,
                        self.mock_portfolio_manager,
                        self.mock_llm_client,
                        self.mock_slack_notifier,
                        loop_end_time,
                    )
                except SystemExit:
